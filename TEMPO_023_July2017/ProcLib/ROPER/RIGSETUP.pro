...
declare constant hide int   Scr_pixX    	= 1024; //640;	// number of pixels across
declare constant hide int   Scr_pixY    	= 768; //400;	// number of pixels in height
declare constant hide float	Refresh_rate	= 120; //70;	// in Hz

// what are your eye variables?
declare float	X_Gain = 50; //3.492;						// x scaling factor to convert eye trace voltage to degrees (must be calculated from calibration)
declare float	Y_Gain = 50; //3.729;						// y scaling factor to convert eye trace voltage to degrees (must be calculated from calibration)
...
declare constant hide int Juice_channel   	= 0; //9 in 029 17 in 023
