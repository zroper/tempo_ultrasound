...
process LSCH_PGS(int curr_target, 																// set SETC_TRL.pro
	...
	if (SetSize == 1)
		{
		spawnwait DRW_PLAC(targ_angle, targ_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		}
	else if (SetSize == 2)	
		{
		spawnwait DRW_PLAC(targ_angle, targ_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d1_angle, d1_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		}
	else if (SetSize == 3)
		{
		spawnwait DRW_PLAC(targ_angle, targ_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d1_angle, d1_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d2_angle, d2_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d3_angle, d3_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		}
	else if (SetSize == 4)	
		{
		spawnwait DRW_PLAC(targ_angle, targ_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		...
		spawnwait DRW_PLAC(d2_angle, d2_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d3_angle, d3_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d4_angle, d4_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d5_angle, d5_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d6_angle, d6_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d7_angle, d7_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		}
	else if (SetSize == 5)	
		{
		spawnwait DRW_PLAC(targ_angle, targ_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		...
		spawnwait DRW_PLAC(d6_angle, d6_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d7_angle, d7_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder	
		spawnwait DRW_PLAC(d8_angle, d8_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d9_angle, d9_ecc, color, fill, deg2pix_X, deg2pix_Y);          	// draw placeholder
		spawnwait DRW_PLAC(d10_angle, d10_ecc, color, fill, deg2pix_X, deg2pix_Y);          // draw placeholder
		spawnwait DRW_PLAC(d11_angle, d11_ecc, color, fill, deg2pix_X, deg2pix_Y);          // draw placeholder  
		}
	...
	if (SetSize > 0)
		...
		if (!Catch)
			...
			{
			spawnwait DRW_T(targ_angle, targ_ecc, color, targ_orient, fill, deg2pix_X, deg2pix_Y);          	// draw distractor
			}
		}
