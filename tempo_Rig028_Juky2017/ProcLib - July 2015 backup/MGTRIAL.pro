...
//				}		
			...
			//Send TTL for stimulation here - this is a hack that needs to be manually turned on/off
			//currently TTL is sent concurrently with search array onset, prior to saccade
						// if (StimTm == 1)
						// {
